...
class SAGE(nn.Module):
    ...
    def forward(self, blocks, feats):
        ...
        quantized, _, commit_loss, dist, codebook, raw_commit_loss, latents = self.vq(h)
        ...
        return h_list, h, loss, dist, codebook, [raw_feat_loss, raw_edge_rec_loss, raw_commit_loss], latents

...
class SAGE(nn.Module):
    ...
    def forward(self, blocks, feats):
        ...
        quantized, _, commit_loss, dist, codebook, raw_commit_loss, latents, margin_loss, pair_loss = self.vq(h)
        quantized_edge = self.decoder_1(quantized)
        quantized_node = self.decoder_2(quantized)
        # --------------------
        # Feat loss
        ...
        return h_list, h, loss, dist, codebook, [raw_feat_loss, raw_edge_rec_loss, raw_commit_loss, margin_loss, pair_loss], latents
    ...
    def inference(self, dataloader, feats):
        ...
        for input_nodes, output_nodes, blocks in dataloader:
            ...
            # Quantize
            # ----------------
            quantized, _, commit_loss, dist, codebook, raw_commit_loss, latent_vectors, margin_loss, pair_loss = self.vq(h)

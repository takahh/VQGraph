...
def get_args():
    ...
    parser.add_argument("--lamb_node", type=float, default=0.00002)  # default=0.001)
    parser.add_argument("--lamb_edge",  type=float, default=0.05)  # default=0.03)
    ...
    parser.add_argument("--learning_rate", type=float, default=0.002) # default=0.0001)

...
def get_args():
    ...
    # VQ
    # --------------
    parser.add_argument("--codebook_size", type=int, default=40, help="Codebook size of VQGraph")
    ...
    parser.add_argument(
        "--hidden_dim", type=int, default=512, help="Model hidden layer dimensions"
    )
    ...
    parser.add_argument(
        "--max_epoch", type=int, default=200, help="Evaluate once per how many epochs"
    )
    parser.add_argument(
        "--patience",
        type=int,

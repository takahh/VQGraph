...
def get_args():
    ...
    # VQ
    # --------------
    parser.add_argument("--codebook_size", type=int, default=2000, help="Codebook size of VQGraph")
...
def run(args):
    ...
    if conf["train_or_infer"] == "infer":
        model.load_state_dict(torch.load("./model_epoch_59.pth", weights_only=False))
